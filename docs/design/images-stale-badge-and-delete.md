...
- Containers legitimately stop/start. `hexstrike-ai:local` is **on-demand** (`restart: "no"`,
...
- "No longer exists" is ambiguous across **two scan sources** (runtime Docker scan on blade-14 +
